...
export default class DinoText extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (this.props.currentVoice !== prevProps.currentVoice) {
  ...
  speak() {
    ...
    utterThis.voice = this.state.allVoices.find(({ name }) => name === this.props.currentVoice.voiceName )


    utterThis.lang = this.props.currentVoice.lang;
    utterThis.pitch = this.props.currentVoice.pitch;
    utterThis.rate = this.props.currentVoice.rate;
